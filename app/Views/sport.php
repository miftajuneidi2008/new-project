...
<div class="container my-5">
    <?php if (!empty($sport)): ?>
        ...
        <div class="small-banner rounded-4 d-flex align-items-center justify-content-center p-4">
            ...
            <img src="<?= base_url('images/' . $sport[0]['photo']) ?>" alt="<?= esc($sport[0]['title']) ?>"
                class="banner-img">

            <!-- 3. The text -->
            <div class="banner-text">
                <h1 class="page-title text-white">የስፖርት ዜና</h1>
            </div>
        </div>
        ...
        <div class="row g-5 mt-2">
            ...
            <div class="col-lg-8">
                ...
                <!-- Article 1 -->
                <?php foreach ($sport as $sport_data): ?>
                    <?php $summary = mb_substr($sport_data['description'], 0, 100); ?>
                    <div class="card article-card-horizontal shadow-sm mb-4">
                        <div class="row g-0">
                            <div class="col-md-4">

                                <img src="<?= base_url('images/' . $sport_data['photo']) ?>"
                                    alt="<?= esc($sport_data['title']) ?>" class="article-img rounded-start-3">
                            </div>
                            <div class="col-md-8 d-flex flex-column">
                                <div class="card-body">
                                    <h5 class="card-title fs-4"><a
                                            href="/news/<?= esc($sport_data['id']) ?>"><?= esc($sport_data['title']) ?></a></h5>

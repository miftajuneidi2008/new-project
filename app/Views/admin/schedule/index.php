...
<div class="container-fluid px-4">
                    ...
                    <div class="card shadow-sm h-100">
                        <div class="card-body d-flex flex-column">
                            ...
                            <p class="card-text flex-grow-1 overflow-hidden" style="max-height: 100px;">
                                <?= substr(strip_tags($schedule['description']), 0, 150) . (strlen(strip_tags($schedule['description'])) > 150 ? '...' : '') ?>
                            </p>
                            <div class="mt-3">


                                <a href="<?= base_url('/admin/schedule/' . $schedule['id'] . '/edit') ?>"
                                    class="btn btn-sm btn-outline-info me-2">አስተካክል</a>

                                <button type="button" class="btn btn-sm btn-outline-danger delete-btn"
                                    data-url="<?= base_url('/admin/schedule/' . $schedule['id']) ?>">
                                    አጥፋ
                                </button>
                            </div>
                        </div>
    ...
    <h2 class="h4 mb-3">አዲስ መርሐግብር ያክሉ</h2>

...
<section>
    ...
    <div class="container mt-5">
        ...
        <a href="/admin/about" class="btn btn-light mb-4">ተመለስ</a>
        ...
        <div class="row">
            ...
            <div class="col-md-8 col-lg-10 card py-2 px-5">
                ...
                <form  action="/admin/about/<?= esc($about['id']);?>" method="post">
                    <?= csrf_field() ?>
                    <div class="mb-4">
                        <input type="hidden" name="_method" value="PUT" />
                    </div>
                    <div class="mb-3">
                        <label for="description" class="form-label fs-5">   የድርጅቱ መረጃ ዝርዝር</label>
                        <textarea class="form-control" name="description" id="description" rows="10"><?= esc($about['description']) ?></textarea>
